  ...
  */
  ...
  function (_Component) {
    ...
    function Swatch(props) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Swatch).call(this, props));
  ...
  function (_Component) {
    ...
    function EditableInput(props) {
      ...
      _this.setUpdatedValue = _this.setUpdatedValue.bind(_assertThisInitialized(_this));
      _this.handleCustomClick = _this.handleCustomClick.bind(_assertThisInitialized(_this));
      return _this;
    }
    ...
    _createClass(EditableInput, [{
      ...
      key: "isColorValid",
      value: function isColorValid(value) {
      ...
      value: function build() {
        ...
        var styles = {
          wrap: assign_1({}, this.props.style.wrap, defaultStyles.wrap),
  ...
  function () {
    ...
    _createClass(Dialog, [{
      ...
      key: "_createWrapper",
      value: function _createWrapper(element) {
        this.uiDialog = jquery("<div>").hide().attr({
      ...
      key: "_show",
      value: function _show(element, option, next) {
        jquery(element).show(option, next());
      }
    }, {
      key: "_hide",
      value: function _hide(element, option, next) {
      ...
      value: function _createOverlay() {
        ...
        this.overlay = jquery("<div>").appendTo(this._appendTo());
      ...
      key: "_moveToTop",
      value: function _moveToTop(event, silent) {
        var moved = false,
  ...
  */
  ...
  function (_Component) {
    ...
    _createClass(Tab, [{
      ...
      value: function build() {
        ...
        var tab = jquery("<div>");
        tab.addClass(classnames(className, (_cx = {}, _defineProperty(_cx, selectedClassName, selected), _defineProperty(_cx, disabledClassName, disabled), _cx)));
        tab.attr("role", "tab");
        tab.attr("id", id);
  ...
  function (_Component) {
    ...
    function TabList(props) {
      ...
      return _possibleConstructorReturn(this, _getPrototypeOf(TabList).call(this, props));
    }
    ...
    _createClass(TabList, [{
      ...
      value: function build() {
        ...
        tabList.addClass(classnames(className));
  ...
  function (_Component) {
    ...
    function TabPanel(props) {
      ...
      return _possibleConstructorReturn(this, _getPrototypeOf(TabPanel).call(this, props));
    }
    ...
    _createClass(TabPanel, [{
      ...
      value: function build() {
        ...
        var tab = jquery("<div>");
        tab.addClass(classnames(className, _defineProperty({}, selectedClassName, selected)));
  ...
  function (_Component) {
    ...
    function UncontrolledTabs(props) {
      ...
      return _possibleConstructorReturn(this, _getPrototypeOf(UncontrolledTabs).call(this, props));
    }
    ...
    _createClass(UncontrolledTabs, [{
      ...
      value: function build() {
        ...
        ucon.addClass(classnames(className));
  ...
  function () {
    ...
    _createClass(mynewcolor, [{
      key: "handleChange",
      value: function handleChange(color, folie) {
        this.color = color;
        this.folie = folie;
      ...
      key: "setColor",
      value: function setColor(color, folie) {
        this.color = color;
        this.folie = folie;
      ...
      key: "_createSwatches",
      value: function _createSwatches(props) {
        var _this = this;
        ...
        map_1(colorPalette, function (c, i) {
          var props = {
            key: i,
            color: c,
            hex: c,
      ...
      value: function _createTaps() {
        ...
        map_1(this.options.taps, function (props, index) {
          ...
          if (props.folie && folieon) {
            aaaaa.push(_this2._createTapsHeader(props, index, selected));
            bbbbb.push(_this2._createTapsPanel(props, index, selected));
          } else if (!props.folie) {
            aaaaa.push(_this2._createTapsHeader(props, index, selected));
            bbbbb.push(_this2._createTapsPanel(props, index, selected));
          }
      ...
      key: "_createTapsHeader",
      value: function _createTapsHeader(props, index, selected) {
      ...
      key: "_createTapsPanel",
      value: function _createTapsPanel(props, index, selected) {
        var id = "react-tabs-" + index;

        var children = this._createSwatches(props);

        var tabpan1 = new TabPanel({
          children: children,
          id: id,
          selected: selected
        });
